...
function Navigation(url)
{
	...
	this.CompTopList = React.createClass({displayName: "CompTopList",
		...
		render : function()
		{
			...
			var items = this.props.data.map(function(data){
				return React.createElement("li", {key: data.name, ref: data.name}, React.createElement("a", {href: data.url, target: data.target}, data.name));
			});
	...
	this.CompSideList = React.createClass({displayName: "CompSideList",
		...
		render : function(){
			...
			var items = this.props.data.map(function(data){
				return (
					React.createElement("li", {"data-ref": data.id}, 
